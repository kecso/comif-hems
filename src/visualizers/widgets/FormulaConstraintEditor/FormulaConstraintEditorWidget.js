...
define([
    ...
    'css!./styles/FormulaConstraintEditorWidget.css'
], function (CodeMirror, LoaderCircles) {
    'use strict';

    var FormulaConstraintEditorWidget,
        WIDGET_CLASS = 'formula-constraint-editor',
        SYNTAX_GUTTER = 'code-syntax';

    FormulaConstraintEditorWidget = function (logger, container) {
    ...
    FormulaConstraintEditorWidget.prototype._initialize = function () {
        var self = this;
    ...
    FormulaConstraintEditorWidget.prototype._setSyntaxError = function (lineNumber, message) {
    ...
    FormulaConstraintEditorWidget.prototype.onWidgetContainerResize = function (width, height) {
    ...
    FormulaConstraintEditorWidget.prototype.onSave = function (/*segmentedDocumentObject*/) {
        this._logger.info('The onSave event is not overwritten!');
    };

    FormulaConstraintEditorWidget.prototype.onChange = function () {
        this._logger.info('The onChange event is not overwritten!');
    };
    /* * * * * * * * Complex document management services  * * * * */
    FormulaConstraintEditorWidget.prototype.setDocumentSegment = function (segmentName, segmentValue) {
    ...
    FormulaConstraintEditorWidget.prototype.setSegmentedDocument = function (segmentedDocumentObject) {
    ...
    FormulaConstraintEditorWidget.prototype.getDocument = function () {
        return this._wholeDocument.getValue();
    };

    FormulaConstraintEditorWidget.prototype.getDocumentSegment = function (segmentName) {
        if (this._segmentedDocument.segments[segmentName]) {
    ...
    FormulaConstraintEditorWidget.prototype.getChangedSegments = function () {
        var segments = {},
            segment, doc;
    ...
    FormulaConstraintEditorWidget.prototype._getNumberOfLinesOfSegment = function (segmentName) {
    ...
    FormulaConstraintEditorWidget.prototype._rebuildCompleteDocument = function () {
    ...
    FormulaConstraintEditorWidget.prototype._setSegmentReadOnly = function (segmentName, readOnly) {
        var segmentInfo,
            fromLine,
            toLine;
        if (this._segmentedDocument.segments[segmentName]) {
    ...
    FormulaConstraintEditorWidget.prototype._save = function () {
    ...
    FormulaConstraintEditorWidget.prototype.destroy = function () {
        this._save();
    };

    FormulaConstraintEditorWidget.prototype.onActivate = function () {
        this._logger.debug('FormulaConstraintEditorWidget has been activated');
    };

    FormulaConstraintEditorWidget.prototype.onDeactivate = function () {
        this._logger.debug('FormulaConstraintEditorWidget has been deactivated');
        this._save();
    };

    return FormulaConstraintEditorWidget;
});
